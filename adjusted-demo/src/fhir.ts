...
// Moderna: 207, Pfizer: 208, AstraZeneca: 210, Novavax: 211, J&J: 212
...
export const toHealthCardData = (fhirBundle: Bundle): HealthCardData => {
    ...
    const immunizations: Immunization[] = immunizationEntries.map(ie => { return { 'code': ie.resource.vaccineCode.coding[0].code, 'lot': ie.resource.lotNumber, 'date': ie.resource.occurrenceDateTime } });
