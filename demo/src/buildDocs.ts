...
//
function buildDocs(markdownPath : string, outputPath : string) {
    ...
    fs.writeFileSync(outputPath, Buffer.from("const verifierDocs = " + JSON.stringify(output, null, 2)));

}

buildDocs('./docs/verifierDocs.md', './public/verifierDocs.js');