const verifierDocs = {
  "scanQRCode": {
    "l": "<p><strong>Requirements for Scanner:</strong><br />\nThe QR Scanner requires that your browser has access to a camera.  </p>\n<p>The browser may only use the camera when using <strong>HTTPS</strong> connection to a remote server (localhost is ok).   </p>\n<p>To Scan your QR code, try to align the QR code within the square overlay.  As camera resolutions may differ, you may have experiment with finding the best alignment. Make sure the QR-code is flat.\n<br><br></p>",
    "r": ""
  },
  "decodeNumeric": {
